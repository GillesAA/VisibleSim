...
#ifndef FaultToleranceCode_H_
#define FaultToleranceCode_H_
...
class FaultToleranceCode : public Catoms3DBlockCode {
private:
  ...
  static int reachableModules;
public :

  Catoms3D::Catoms3DBlock *catom;
	FaultToleranceCode(Catoms3DBlock *host);
	~FaultToleranceCode() {};
...
/**
  ...
  */
    ...
    static vector<pair<P2PNetworkInterface*, FaultToleranceCode*>>  getRandomInterfaces(float p);
    static int breakInterfaces(float p_interfaces);

/*****************************************************************************/
/** needed to associate code to module                                      **/
	static BlockCode *buildNewBlockCode(BuildingBlock *host) {
	    return(new FaultToleranceCode((Catoms3DBlock*)host));
	}
/*****************************************************************************/
};

#endif /* FaultToleranceCode_H_ */